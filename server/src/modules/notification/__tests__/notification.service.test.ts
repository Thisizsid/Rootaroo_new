...
describe('Notification Service', () => {
  ...
  describe('sendToUser / getUnreadCount', () => {
    it('creates a history record when sending', async () => {
      ...
      (modelsMock.DeviceToken.findAll as jest.Mock).mockResolvedValue([]);
  ...
  describe('sendToUser preference gating (F-08)', () => {
    ...
    it('should still record history but skip the push when the mapped preference is disabled', async () => {
