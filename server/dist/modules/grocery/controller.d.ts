...
export declare function toggle(req: Request, res: Response, next: NextFunction): Promise<void>;
export declare function archive(req: Request, res: Response, next: NextFunction): Promise<void>;
