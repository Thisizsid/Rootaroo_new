...
router.post('/', (0, validate_1.validate)(validation_1.createTodoSchema), ctrl.create); // FR-070
router.get('/', ctrl.list); // FR-075
router.patch('/:id', (0, validate_1.validate)(validation_1.updateTodoSchema), ctrl.update); // FR-073
