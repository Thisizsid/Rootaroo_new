...
// Device tokens
router.post('/tokens', (0, validate_1.validate)(validation_1.deviceTokenSchema), ctrl.registerToken);
...
router.patch('/preferences', (0, validate_1.validate)(validation_1.updatePreferencesSchema), ctrl.updatePreferences);
